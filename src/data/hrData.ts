...
export const staffData: Staff[] = [
  ...
  { id: "EMP004", staffId: "STF-004", name: "Suresh Gupta",    role: "Admin",     branch: "Trichy", branchId: "Trichy", contact: "9876543213", email: `suresh.g@${domain}`,  status: "Active",   salary: 30000, phone: "9876543213", subjects: [],                                classes: [],                       joinDate: "2019-03-01", gender: "Male",   qualification: "B.Com",          experience: 7 },
  ...
  { id: "EMP006", staffId: "STF-006", name: "Kavita Singh",    role: "Teacher",   branch: "Trichy", branchId: "Trichy", contact: "9876543215", email: `kavita.s@${domain}`,  status: "Inactive", salary: 28000, phone: "9876543215", subjects: ["Biology"],                classes: ["Class 11"],             joinDate: "2020-08-01", gender: "Female", qualification: "M.Sc Biology",   experience: 5 },
